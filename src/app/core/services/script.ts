...
export class ScriptsService {
  ...
  getAll(): Observable<any> {
    ...
    return this.http.get(`${this.base_url}scripts`, options);
  }
  getAllFilters(accion:string = ""): Observable<any> {
    ...
    return this.http.get(`${this.base_url}scripts_filter/${accion}`, options);
  }
  ...
  getOne(id: any): Observable<any> {
    ...
    return this.http.get(`${this.base_url}scripts/${id}`, options);
  }
  ...
  save(data: any, id=""): Observable<any> {
    ...
    if (id == ""){
      return this.http.post(`${this.base_url}script`, data, options);
    } else {
      return this.http.put(`${this.base_url}script/${id}`, data, options);
    }
  }
  ...
  delete(id: any): Observable<any> {
    ...
    return this.http.delete(`${this.base_url}script/${id}`, options);
  }
  ...
  recovery(id: any): Observable<any> {
    ...
    return this.http.put(`${this.base_url}script_recuperar/${id}`, null, options);
  }
