...
export class TemplateService {
  ...
  getAll(): Observable<any> {
    ...
    return this.http.get(`${this.base_url}templates`, options);
  }
  getAllFilters(accion:string = ""): Observable<any> {
    ...
    return this.http.get(`${this.base_url}templates_filter/${accion}`, options);
  }
  ...
  getOne(id: any): Observable<any> {
    ...
    return this.http.get(`${this.base_url}templates/${id}`, options);
  }
  ...
  save(data: any, id=""): Observable<any> {
    ...
    if (id == ""){
      return this.http.post(`${this.base_url}template`, data, options);
    } else {
      return this.http.put(`${this.base_url}template/${id}`, data, options);
    }
  }
  ...
  delete(id: any): Observable<any> {
    ...
    return this.http.delete(`${this.base_url}template/${id}`, options);
  }
  ...
  recovery(id: any): Observable<any> {
    ...
    return this.http.put(`${this.base_url}template_recuperar/${id}`, null, options);
  }
