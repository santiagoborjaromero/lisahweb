...
export class VariablesService {
  ...
  getAll(): Observable<any> {
    ...
    return this.http.get(`${this.base_url}variables`, options);
...
//   }
  ...
  getOne(id: any): Observable<any> {
    ...
    return this.http.get(`${this.base_url}variable/${id}`, options);
  }
...
//     };
//     if (id == ""){
//       return this.http.post(`${this.base_url}usuario`, data, options);
//     } else {
//       return this.http.put(`${this.base_url}usuario/${id}`, data, options);
//     }
//   }
